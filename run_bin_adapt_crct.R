...
trial_props <- list()
for(j in 1:60){
  for(i in seq(2,5000,2)){ #the middle number is the total number of items in the list
...
tempd <- list()
for(j in c(1:60)){
  for(i in seq(1,5000,2)){ #the middle number is the total number of items in the list
...
#saveRDS(outsim2,here("Data","adaptprob_outsim.RDS"))
